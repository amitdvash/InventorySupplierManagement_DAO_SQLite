...
public class Supplier {
    ...
    public Supplier(String companyID, String bankAccount, PaymentMethod paymentMethod,
                    List<Product> productList, Agreement supplierAgreement, SupplierContact contact) {
